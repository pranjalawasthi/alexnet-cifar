...
def read_input():
	...
	d=unpickle('C:/Users/pranjal/Downloads/cifar-10/cifar-10-batches-py/data_batch_1')
	trn_all_data.append(d[b'data'])
	trn_all_labels.append(d[b'labels'])
	#print(sys.getsizeof(trn_all_data))

	d=unpickle('C:/Users/pranjal/Downloads/cifar-10/cifar-10-batches-py/data_batch_2')
	trn_all_data.append(d[b'data'])
	trn_all_labels.append(d[b'labels'])

	d=unpickle('C:/Users/pranjal/Downloads/cifar-10/cifar-10-batches-py/data_batch_3')
	trn_all_data.append(d[b'data'])
	trn_all_labels.append(d[b'labels'])

	d=unpickle('C:/Users/pranjal/Downloads/cifar-10/cifar-10-batches-py/data_batch_4')
	trn_all_data.append(d[b'data'])
	trn_all_labels.append(d[b'labels'])

	d=unpickle('C:/Users/pranjal/Downloads/cifar-10/cifar-10-batches-py/data_batch_5')
	trn_all_data.append(d[b'data'])
	trn_all_labels.append(d[b'labels'])
